...
//                        div('div', 'pages-bottom'),
                        div('div', 'headerj').css('background-color', settings.color).append(
                            div('a', 'prv-m'),
                            div('h1'),
                            div('a', 'nxt-m'),
                            div('div', 'day-names')
                        ),
                        div('div', 'total-bar').html( lTotalEvents[settings.lang] + '<b style="color: '+settings.color+'"></b>' + ' 节'),
                        div('div', 'days')
                    ),
...
//                            div('h3','').append(div('span', '').html('<b></b> ' + lEvent[settings.lang])), -- 屈海涛 注释统计今日任务数
            ...
            function calcMonth() {
                ...
                $this.find('.headerj h1').html(monthNames[settings.lang][month] + ' ' + year);
                    ...
                    $this.find('.this-month[data-date="' + $(this).attr('data-date') + '"]').append(
                        div('div','event-single').attr('data-id', i).append(
                            ...
                            div('div','details').append(
                                div('div', 'clock').text($(this).attr('data-class')).append($(this).attr('data-nbsp')).append($(this).attr('data-time')).append($(this).attr('data-nbsp')).append($(this).attr('data-teacher')),
                                div('div', 'erase')
                            )
                        )
                    );
            ...
            function calcTotalDayAgain() {
                ...
                //$this.find('.events h3 span b').text($this.find('.events .event-single').length) -- 屈海涛 注释统计今日任务数
            }
            ...
            $this.on('click', '.this-month', function () {
                ...
                $this.children('.jalendar-wood, .wood-bottom').animate({width : '+=700px' }, 200, function() {
